...
- [n8n-pipeline](n8n-pipeline/) — контент-конвейер в n8n: список тем → готовые
  посты; три рубежа против выдуманной статистики, включая фильтр кодом
- [site-widget](site-widget/) — виджет-консультант на сайт: чат по базе знаний
  бизнеса, ключ модели спрятан за прокси и в браузер не попадает

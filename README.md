...
- [saoz-demo](saoz-demo/) — конвейер обработки заявок: документы → извлечение через ИИ →
  предквалификация по версионируемым правилам → вердикт с разбором и источниками
